package com.spring.hederaspringstarter.utilities;
...
public class HederaClient {
	...
	public static Client makeNewClient(AccountId accountId, Ed25519PrivateKey privateKey) {
		Client client = (EnvUtils.getHederaEnvironment()== EnvUtils.Hedera_Environment.TESTNET) ? Client.forTestnet() : Client.forMainnet();
